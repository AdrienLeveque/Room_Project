		...
		<div class="container">
			<div class="col-md-12">
					...
					$idReservation=$_GET['id'];
						...
						$prixSalle=$infosSalle->tarif_salle;
				...
				<div class="col-md-6">
					<fieldset>
						...
						<div class="col-md-12"><label>Reduction :</label><?php if(!is_null($reduction)) {echo $reduction.'%';}?></div>
						<div class="col-md-12"><label>Prix de la salle :</label><?php if(!is_null($prixSalle)) {echo $prixSalle;}?></div>
						<div class="col-md-12"><label>caution de la salle :</label><?php if(!is_null($caution_salle)) {echo $caution_salle;}?></div>
						</div>
					</fieldset>
				</div>
				<div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<ul>
							...
							if($reduction!=0){
								$prix_avec_reduction=$prixSalle-($prixSalle/$reduction) + $caution_salle;
							}else{
								$prix_avec_reduction=$prixSalle + $caution_salle;
							}
				...
				<div class="col-md-offset-3 col-md-6">
					<fieldset>
						<legend> Prix total (avec réduction) : <?php echo $prix_avec_reduction."€";?></legend>
