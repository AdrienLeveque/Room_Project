...
<head>
    ...
    <script src="kalendae/build/kalendae.standalone.js" type="text/javascript" charset="utf-8"></script>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                   <strong> Mairie de la ville d'Orsay </strong>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php if(Auth::guest()): ?>
                        <li <?php echo $__env->yieldContent('connexion'); ?>><a href="<?php echo e(url('/login')); ?>">Connexion</a></li>
                        <li <?php echo $__env->yieldContent('inscription'); ?>><a href="<?php echo e(url('/register')); ?>">Inscription</a></li>
                    <?php else: ?>
                        <li class="dropdown">
